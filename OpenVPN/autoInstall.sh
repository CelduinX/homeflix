...
curl -sSL https://raw.githubusercontent.com/CelduinX/homeflix/main/OpenVPN/docker-compose.yml -o docker-compose.yml
curl -sSL https://raw.githubusercontent.com/CelduinX/homeflix/main/OpenVPN/.env -o .env
